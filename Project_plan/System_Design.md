...
-- 1. MEMBERS Table
-- Tracks internal family/business profiles and external debtors (e.g. BTC, External Debtor C)
CREATE TABLE members (
    id TEXT PRIMARY KEY,                       -- UUID string
    name TEXT NOT NULL,                        -- Name of the member or debtor
    is_external BOOLEAN NOT NULL DEFAULT 0,    -- 0 = Internal member (Admin, Father), 1 = External debtor (BTC, External Debtor C)
