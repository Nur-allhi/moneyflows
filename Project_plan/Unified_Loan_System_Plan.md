...
# Manual test flows:
# 1. Create a loan (Admin's Cash → John, 5000)
# 2. Verify "Lend" transaction appears in ledger
# 3. Create another loan (Admin's Cash → Sara's Wallet, 3000)
# 4. Repay John's loan (2000)
# 5. Verify outstanding for John = 3000, Sara unaffected
# 6. Open Transaction Detail Modal → shows "Lender: Admin's Cash" / "Borrower: John"
