...
const defaultLedger: LedgerRow[] = [
  ...
  { date: '22 Jun', description: 'Transfer to Mother', debit: '10,000', credit: '\u2014', balance: '-50,359', type: 'transfer' },
...
const defaultGoals: SavingsGoal[] = [
  ...
  { icon: '\u{1F4DA}', title: 'Study Fund (Mother)', percent: 55, detail: '55,000 / 1,00,000 BDT', addition: '+5K' },
];
