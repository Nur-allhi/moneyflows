...
export function Dashboard() {
  ...
  const { locale, currency, loading, error, totalAssets, cashInHand, totalInBanks, activeLoansOutstanding, assetsChange, cashChange, banksChange, loansChange, thisMonthIncome, thisMonthExpenses, thisMonthNet, filteredAccountsByMember, memberById, internalMembers, filteredRecentTxs, activeLoanStacks } = d as any;
  ...
  return (
    <div className={styles.dashboard}>
      <MetricCards assetsChange={assetsChange} cashChange={cashChange} banksChange={banksChange} loansChange={loansChange} locale={locale} currency={currency} animTotalAssets={animTotalAssets} animCashInHand={animCashInHand} animTotalInBanks={animTotalInBanks} animActiveLoans={animActiveLoans} />
