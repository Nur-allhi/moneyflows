...
const defaultAccounts: AccountData[] = [
  { id: '1', name: 'Brac Bank (Admin)', type: 'bank', balance: '1,12,400', icon: 'B', accentColor: 'var(--color-income)' },
  { id: '2', name: 'bKash (Admin)', type: 'mobile_wallet', balance: '24,670', icon: 'bK', accentColor: 'var(--color-cash)' },
  { id: '3', name: 'Business Cash (Admin)', type: 'cash', balance: '52,130', icon: 'C', accentColor: 'var(--color-income)' },
  { id: '4', name: 'Nagad (Father)', type: 'mobile_wallet', balance: '18,900', icon: 'N', accentColor: 'var(--color-cash)' },
  { id: '5', name: 'DBBL (Mother)', type: 'savings', balance: '36,200', icon: 'D', accentColor: 'var(--color-income)' },
];
...
const defaultTransactions: TransactionData[] = [
  ...
  { id: '7', description: 'Sent to Mother', date: '22 Jun, 07:10 PM', amount: '10,000', type: 'transfer' },
];
