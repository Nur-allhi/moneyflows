...
const defaultItems: RecycleItem[] = [
  { id: '1', icon: '\u26A0', iconVariant: 'warning', name: 'Milk, Pawruti', meta: 'Expense \u2022 Admin \u2022 bKash', amount: '-320 BDT', amountColor: 'var(--color-expense)', date: 'Today, 10:32 AM', type: 'transaction' },
  { id: '2', icon: '\u26A0', iconVariant: 'warning', name: 'Electricity Bill', meta: 'Expense \u2022 Admin \u2022 Brac Bank', amount: '-2,450 BDT', amountColor: 'var(--color-expense)', date: 'Yesterday, 04:15 PM', type: 'transaction' },
  { id: '3', icon: '\u26A0', iconVariant: 'warning', name: 'Bazar Weekly', meta: 'Expense \u2022 Mother \u2022 DBBL', amount: '-4,200 BDT', amountColor: 'var(--color-expense)', date: '3 days ago', type: 'transaction' },
  { id: '4', icon: '\u26A0', iconVariant: 'warning', name: 'Transfer to Mother', meta: 'Transfer \u2022 Admin \u2022 bKash \u2192 DBBL', amount: '-10,000 BDT', amountColor: 'var(--color-expense)', date: '5 days ago', type: 'transaction' },
  { id: '5', icon: '\u26A0', iconVariant: 'warning', name: 'bKash Cash Out', meta: 'Expense \u2022 Father \u2022 Nagad', amount: '-2,000 BDT', amountColor: 'var(--color-expense)', date: '6 days ago', type: 'transaction' },
  { id: '6', icon: '\u{1F3E6}', iconVariant: 'account', name: 'Rocket Wallet (Father)', meta: 'Account \u2022 Deleted 12 Jun', amount: '\u2014', amountColor: 'var(--color-text-secondary)', date: '12 Jun', type: 'account' },
  { id: '7', icon: '\u{1F3E6}', iconVariant: 'account', name: 'UPay Wallet (Mother)', meta: 'Account \u2022 Deleted 8 Jun', amount: '\u2014', amountColor: 'var(--color-text-secondary)', date: '8 Jun', type: 'account' },
];
