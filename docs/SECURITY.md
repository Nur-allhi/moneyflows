...
| Level | Scope | Who |
|-------|-------|-----|
| **Admin** | Full CRUD: members, accounts, transactions, loans, recycle bin | Admin (hardcoded as primary user) |
| **Viewer** | Read-only: dashboard, member profile, loan stacks | Father, Mother (family viewers) |
